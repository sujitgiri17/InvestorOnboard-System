  ...
  return (
    <>
      ...
      <LeftSection
        ...
        charts, an elegant UI, and more. Enjoy the Kite experience seamlessly on your Android and iOS 
        devices."
        tryDemo=""
        learnMore=""
        googlePla=""
      ...
      <LeftSection
       ...
       illustrations. Content is broken down into bite-size cards to help you learn on the go. "
        ...
        appStore=""
      />
      <p className="text-center fs-4 mt-5 mb-5">Want to know more about our technology stack? Check out the <a className="p-1" style={{textDecoration:"none"}}> Zerodha.tech </a>blog.</p>
